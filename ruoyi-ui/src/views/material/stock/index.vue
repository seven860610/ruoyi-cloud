<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="管理员" prop="stockManager">
        <el-input
          v-model="queryParams.stockManager"
          placeholder="请输入管理员"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="infoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="管理员" align="center" prop="stockManager" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="仓库类型" prop="stockType">
          <el-input v-model="form.stockType" placeholder="请输入仓库类型" />
        </el-form-item>
        <el-form-item label="管理员" prop="stockManager">
          <el-input v-model="form.stockManager" placeholder="请输入管理员" />
        </el-form-item>
      </el-form>
